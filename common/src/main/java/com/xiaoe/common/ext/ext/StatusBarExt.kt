...
import com.xiaoe.common.utils.status.QMUIStatusBarHelper
import com.xiaoe.common.utils.status.StatusBarUtil


//apply for StatusBarUtil
//使用了状态栏填充之后，整体布局会往上，需要调整布局
//在xml中需要修改的View加上：
//android:contentDescription="status_padding" 修改布局的padding

...
//                is SmartRefreshLayout -> outputViews[0].findViewById(R.id.mRecycleView)
            ...
            targetParent.apply {
                ...
                val stateView = MultiStateView(targetRoot.context).apply {
                    ...
                    setViewForState(R.layout.common_error_view, MultiStateView.VIEW_STATE_ERROR)
                    setViewForState(R.layout.common_empty_view, MultiStateView.VIEW_STATE_EMPTY)
                    setViewForState(R.layout.common_loading_view, MultiStateView.VIEW_STATE_LOADING)
